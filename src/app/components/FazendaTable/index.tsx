...
type fazendaTableProps = {
  data?: Fazenda[];
  onEdit?: (user: Fazenda) => void;
  onDelete?: (user: Fazenda) => void;
};

const FazendaTable: React.FC<fazendaTableProps> = ({ data, onEdit, onDelete }) => {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200 bg-white">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Hectares</th>
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Tipod</th>
